...
This directory is where all the real documentation lives (as oppposed to whatever's scattered in my head).
...
| Document | What it covers |
|---|---|
| [development/worklog.md](development/worklog.md) | Active sprint log, mostly for me to remember what I was doing |
| [../README.md](../README.md) | Project overview and setup |

---

## Quick Reference — Capability Constants (the stuff I always forget the exact name of)
