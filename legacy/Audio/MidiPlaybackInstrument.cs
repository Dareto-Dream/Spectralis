...
internal enum MidiPlaybackInstrument
{
    FilePrograms,
    AcousticGrandPiano,
    BrightAcousticPiano,
...
internal static class MidiPlaybackInstrumentCatalog
{
    public static SelectionOption<MidiPlaybackInstrument>[] GetOptions() =>
    [
