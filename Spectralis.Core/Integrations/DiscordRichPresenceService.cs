...
public sealed class DiscordRichPresenceService : IDisposable
{
        ...
        int queueCount)
    {
        var presence = new RichPresence
        {
            ...
            Details = ClampPresenceText(track.DisplayTitle, "Untitled track"),
    ...
    private static string BuildStateText(TrackInfo track, bool isPlaying, TimeSpan position, int queuePosition, int queueCount)
    {
