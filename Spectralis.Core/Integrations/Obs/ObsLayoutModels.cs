...
public static class ObsWidgetType
{
...
public static class ObsVisualizerKeys
{
    public const string BuiltInPrefix = "builtin:";

    /// <summary>Same key shape the WinForms VisualizerChoice produced ("builtin:MirrorSpectrum").</summary>
    public static string VisualizerKey(VisualizerMode mode) => BuiltInPrefix + mode;
}

public sealed class ObsLayoutWidget
{
    [JsonPropertyName("type")]         public string Type          { get; set; } = ObsWidgetType.NowPlaying;
    /// <summary>X position as fraction of stream width (0â€“1)</summary>
    [JsonPropertyName("x")]            public double X             { get; set; }
    /// <summary>Y position as fraction of stream height (0â€“1)</summary>
    ...
    public static ObsLayout CreateDefault() => new()
    {
        ...
        [
            ...
            new ObsLayoutWidget
            {
                ...
                VizKey = ObsVisualizerKeys.VisualizerKey(VisualizerMode.MirrorSpectrum),
...
public static class BuiltInObsPresets
{
    private static string VK(VisualizerMode m) => ObsVisualizerKeys.VisualizerKey(m);
