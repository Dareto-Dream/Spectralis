...
public sealed class ObsTrackState
{
...
public sealed class ObsPlaybackState
{
...
public sealed class ObsLyricsState
{
...
public sealed class ObsQueueItem
{
    [JsonPropertyName("title")]     public string Title { get; init; } = "";
    [JsonPropertyName("artist")]    public string Artist { get; init; } = "";
...
public sealed class ObsVisualizerState
{
...
public sealed class ObsThemeState
{
...
public sealed class ObsSongWarsState
{
...
public sealed class ObsSongWarsSubmission
{
...
public sealed class ObsSongWarsMatch
{
    [JsonPropertyName("id")]              public string Id { get; init; } = "";
